...
#include <memory>
#include "../MyRemoteControl/netclient.h"
...
QT_MOC_LITERAL(3, 20, 18), // "common::packetType"
QT_MOC_LITERAL(4, 39, 4), // "type"
QT_MOC_LITERAL(5, 44, 5), // "char*"
QT_MOC_LITERAL(6, 50, 4) // "data"

    },
    "NetClient\0readData\0\0common::packetType\0"
    "type\0char*\0data"
};
...
void NetClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->readData((*reinterpret_cast< common::packetType(*)>(_a[1])),(*reinterpret_cast< char*(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NetClient::*)(common::packetType , char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetClient::readData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetClient::readData(common::packetType _t1, char * _t2)
{
