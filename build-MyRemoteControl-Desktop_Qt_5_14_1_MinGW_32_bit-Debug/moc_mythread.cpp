...
#include <memory>
#include "../MyRemoteControl/mythread.h"
...
QT_MOC_LITERAL(1, 9, 16), // "client_send_data"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "type"
QT_MOC_LITERAL(4, 32, 4) // "data"

    },
    "MyThread\0client_send_data\0\0type\0data"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::client_send_data)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::client_send_data(int _t1, QByteArray _t2)
{
